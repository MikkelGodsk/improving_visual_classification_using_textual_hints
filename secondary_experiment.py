...
if __name__ == '__main__':
    ...
    print("Addition + avg. seq. Regularization rate = 0.")
    ...
    print("Regularization experiment (control): Weightsum based, avg. sequence. for reg=1e-2")
    print("Control: Using a 80-20 split")
    experiment2 = HintsExperiment(
        directory='/work3/s184399/trained_models/weightsum_seqavg_trainwiki_valwnet_dynamic_masking_70pct_reg_1e-2_control'
    )
